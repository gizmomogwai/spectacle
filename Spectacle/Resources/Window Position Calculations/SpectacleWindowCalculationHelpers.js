var SpectacleCalculationHelpers = (function () {
    ...
    var isLeftOrRight = function(rect, total) {
        return almostEqual(rect, calcLeftHalf(total)) || almostEqual(rect, calcRightHalf(total));
    };
    var isTopOrBottom = function(rect, total) {
        return almostEqual(rect, calcTopHalf(total)) || almostEqual(rect, calcBottomHalf(total));
    };
    return {
        copyRect: copyRect,
